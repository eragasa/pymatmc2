...
#
# HISTORICAL REFERENCE ONLY. This file is a modified work derived from the
# abICS run_base_mpi.py implementation identified in references/mc2/README.md.
# The historical MIT statement below does not apply to the abICS-derived
# portions. This reference is not imported by the pymatmc2 package.
...
class MultiCellMonteCarloMpiSpawn(MultiCellMonteCarlo):
    """ Implementation of the (MC)^2

    This class implements the algorithm as described in [1].  Requires a VASP patch.
    ...
    [2] ab-Initio Configuration Sampling Tool kit (abICS). https://github.com/issp-center-dev/abICS/blob/master/abics/applications/latgas_abinitio_interface/run_base_mpi.py
