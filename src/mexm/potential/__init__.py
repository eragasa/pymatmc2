...
MEXM_HYBRID_2BODY_FMT = "{symbol1}{symbol2}_{potential_type}_{parameter_name}"
...
def get_pair_parameter_names(symbols,pair_parameter_names):
...
# Base Potential
#------------------------------------------------------------------------------
from mexm.potential.potential import Potential
from mexm.potential.pair import PairPotential
from mexm.potential.threebody import ThreeBodyPotential
from mexm.potential.eam_density_function import EamDensityFunction
...
#------------------------------------------------------------------------------
from mexm.potential.pair_morse import MorsePotential
from mexm.potential.pair_buckingham import BuckinghamPotential
from mexm.potential.pair_bornmayer import BornMayerPotential
from mexm.potential.pair_lj import LennardJonesPotential
from mexm.potential.pair_general_lj import GeneralizedLennardJonesPotential
