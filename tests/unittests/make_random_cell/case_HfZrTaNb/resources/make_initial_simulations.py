...
def make_poscar_files(src_configuration_path, phase_paths):
    ...
    total_concentration = o_configuration.total_concentration
    for phase in phase_paths:
        cell_type = 'bcc'
        cell = create_random_cell(cell_type=cell_type, composition=total_concentration, supercell=[2,2,2])
...
if __name__ == "__main__":
    ...
    configuration.read(path=src_configuration_path)
    phase_paths = configuration.cell_names
